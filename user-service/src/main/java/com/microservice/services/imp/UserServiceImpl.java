...
import com.microservice.ext.services.HotelService;
...
public class UserServiceImpl implements UserService {
	...
	@Autowired
	private HotelService hotelServiceFeign;
	...
	public User getUser(String userId) {
		...
		//List<Rating> ratingsArr=restTemplate.getForObject("http://localhost:9092/ratings/users/"+userId , ArrayList.class);
		...
		List<Rating> ratingsWithHotelInfo= ratingsList.stream().map(rating->{
			...
			/* now commenting this lines for getting hotel using feign client
			...
			*/ 
			...
			//now we are using feign to get hotel and commenting above two lines code of restTempate implementation
